...
$sql = $database->prepare(
	"CREATE TABLE IF NOT EXISTS room_reservation (room_nr varchar(255) NOT NULL,user_email varchar(255) NOT NULL, fromDate datetime NOT NULL, toDate datetime NOT NULL, token varchar(255) NOT NULL, confirmed boolean, PRIMARY KEY (room_nr, token), FOREIGN KEY (room_nr) REFERENCES room(room_nr));"
);
$sql->execute();
